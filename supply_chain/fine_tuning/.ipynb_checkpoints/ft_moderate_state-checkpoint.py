...
class TestModerateState(Generator):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.edge_expected_lengths = np.full(self.num_edges, 2, dtype=self.int_dtype)
        ...
        # Overwrite the last 3 edges (prices), shape = num_edge, num_cost, num_timesteps
