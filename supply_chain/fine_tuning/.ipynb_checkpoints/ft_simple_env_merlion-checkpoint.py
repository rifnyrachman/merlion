...
from .ft_simple_state import TestSimpleState # import test simple state
...
class TestSimpleSC(gym.Env):
    def __init__(self, *args, **kwargs):
        self.state = TestSimpleState(num_timesteps=100)()[0] # Call test state
        self.agents = agents
        self.artefacts = None
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.state = TestSimpleState(num_timesteps = 100)()[0] #generate a new state
