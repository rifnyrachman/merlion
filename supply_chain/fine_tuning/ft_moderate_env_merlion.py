...
from .ft_moderate_state import TestModerateState
...
class TestModerateSC(gym.Env):
    def __init__(self, *args, **kwargs):
        self.state = TestModerateState(num_timesteps=100)()[0]
        self.agents = agents
        self.artefacts = None
    ...
    def _step_state(self):
        ...
        for agent in self.agents:
            ...
            agent.apply(self.timestep, self.state, self.artefacts) #apply transform at each timesteps
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.state = TestModerateState(num_timesteps = 100)()[0] #generate a new state
...
def make_env(env_config=None):
    base = TestModerateSC() # change Test
